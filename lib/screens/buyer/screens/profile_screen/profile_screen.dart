              ...
              builder: (context, state) {
                if (state is ErorProfileState) {
                  return ButtonTryAgainWidget(
                    onTabFunction: () => _profileBloc.add(
                      GetProfileEvent(),
                    ),
                          ...
                          child: Column(
                            children: [
                              ...
                              ChangeInfoTextFieldWidget(
                                ...
                                value: state.profileModelList.username,
                              ),
                              SizedBox(height: 20.h),
                              ChangeInfoTextFieldWidget(
                                width: 210,
                                ...
                                value: state.profileModelList.email,
                              ),
                              SizedBox(height: 20.h),
                              ChangeInfoTextFieldWidget(
                                width: 123,
                                ...
                                value: state.profileModelList.phone,
                              ),
                              // SizedBox(height: 20.h),
                              // ChangeInfoTextFieldWidget(
                              //   width: 193,
